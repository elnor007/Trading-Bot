Developed a trading bot using the MetaTrader5 Python API. The algorithm aims to place pending orders which are equally spaced from one another and also ensures that each order 
